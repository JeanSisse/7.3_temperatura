...
#define TOTAL_EM_FITS 1268.0
#define TOTAL_SM_FITS 800.0
#define TOTAL_TDDB_FITS 800.0
#define TOTAL_TC_FITS 800.0
#define TOTAL_NBTI_FITS 800.0

#define T_base 345.0	/* Qualification temperature. At this value, the total processor FIT value will be 4000. By changing this temperature, we can model processors with different reliability qualification costs (Higher implies more expensive).*/ 
...
typedef struct floorplan_structure_st
{
	unit *units;
	int n_units;
  	double **wire_density;
