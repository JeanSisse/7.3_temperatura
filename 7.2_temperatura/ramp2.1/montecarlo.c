...
float expected_mttf[5][10];
float lognorm_lambda[5][10];
float lognorm_lifetime[5][10];
float structure_lifetime[10];
float fits[5][10];
...
for (structure_count=0;structure_count<9;structure_count++)
	{
	for (fail_count=0;fail_count<1;fail_count++)
	{
